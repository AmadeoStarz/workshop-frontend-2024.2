...
const Iso = {
  ...
  backgroundGradientColors: ['c4a1ffff', '3d0fd4ff', '20155dff', 'ac52ffff'],
  assetPath: 'ShooterGame/Content/Characters/Sequoia/Sequoia_BasePrimaryAsset',
  isFullPortraitRightFacing: false,
  isPlayableCharacter: true,
  isAvailableForTest: false,
  isBaseContent: false,
...
const Deadlock = {
  ...
  backgroundGradientColors: ['bcc2ffff', '4d64c4ff', '221c3dff', '22224bff'],
...
const Clove = {
  ...
  backgroundGradientColors: ['f17cadff', '062261ff', 'c347c7ff', 'f1db6fff'],
  assetPath: 'ShooterGame/Content/Characters/Smonk/Smonk_PrimaryAsset',
  isFullPortraitRightFacing: false,
  isPlayableCharacter: true,
  isAvailableForTest: true,
  isBaseContent: false,
  ...
  recruitmentData: {
    counterId: '1064ba88-4cd9-8d5b-cbe5-d784b3568820',
    milestoneId: 'ac3d5972-4ad9-003f-3da8-5881db5a19ec',
    milestoneThreshold: 200000,
    useLevelVpCostOverride: false,
    levelVpCostOverride: 0,
    startDate: '2024-03-25T13:00:00Z',
    endDate: '2024-04-24T22:00:00Z'
  },
  abilities: [
    {
      slot: 'Grenade',
